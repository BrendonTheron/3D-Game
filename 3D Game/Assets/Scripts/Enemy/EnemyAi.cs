...
{   
    ...
    void Start()
    {
        ...
        alien.isStopped= false;
        alien.speed=speedWalk;
        alien.SetDestination(waypoints[m_currentWaypointIndex].position);
    }
    ...
    private void Chasing()
    {
        ...
        {
            Move(speedRun);
            alien.SetDestination(m_PlayerPosition);
        }
        if(alien.remainingDistance<=alien.stoppingDistance)
        {
